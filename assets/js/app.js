...
const speakers = [
  {
    ...
    description: `The backstory to this person, all based on literally nothing, who knows what they've done`,
    image: `/assets/img/Speaker1.png`
  },
  {
    name: `Wei R Dname`,
    intro: `A known renown person, who is a basic as most can be`,
    description: `I've spent years researching the habits and habitats of unicorns, dragons, and other fantastical beasts.`,
    image: `/assets/img/Speaker2.png`
  },
  {
    name: `Norm Alname`,
    intro: `Lesser known person, who is less known`,
    description: `From the absurd poetry of Edward Lear to the nonsensical plays of the Dadaists, I've devoted my career to understanding.`,
  ...
  },
  {
    ...
    description: `Whether it's exploring the role of humor in coping with stress or the psychological benefits.`,
